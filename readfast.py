...
def dododo(dododo_time):
    ...
    while True:
        try:
                    driver.get(url11)
                    print("正在进行阅读第1篇文章："+url11)
                    time.sleep(120)
                    driver.get(url12)
                    print("正在进行阅读第2篇文章："+url12)
                    time.sleep(120)
                    driver.get(url13)
                    print("正在进行阅读第3篇文章："+url13)
                    time.sleep(120)
                    driver.get(url14)
                    print("正在进行阅读第4篇文章："+url14)
                    time.sleep(120)
                    driver.get(url15)
                    print("正在进行阅读第5篇文章："+url15)
                    time.sleep(150)
                    driver.get(url21)
                    print("正在随机听课："+url21)
                    time.sleep(620)
                    driver.get(url31)
                    print("正在查看第1篇精选文章："+url31)
                    time.sleep(60)
                    driver.get(url32)
                    print("正在查看第2篇精选文章："+url32)
                    time.sleep(66)
                    print("你已完成本日任务！，正在为您跳转")
                    time.sleep(10)
                    driver.get(urlend)
